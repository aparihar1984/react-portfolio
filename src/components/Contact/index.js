    ...
    <section id="reach-out" className="contact">
      ...
      <div className="contact-info">
        <div>
          ...
          <address>
            Calgary, AB <br />
            P: <a href="tel:951.310.5642">480.307.4455</a>
            <br />
            E:{" "}
            <a href="mailto://aparihar@email.arizona.edu">
              aparihar@email.arizona.edu
            </a>
          </address>
          <p>
            <strong>It would be great to hear your feedback!</strong>
          </p>
        </div>
